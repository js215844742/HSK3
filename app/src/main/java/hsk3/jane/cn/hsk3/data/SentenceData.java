...
public class SentenceData {
    ...
    public static String[] SYNTAX = {
            ...
            "N+Adv+V+过+N+了。\nN+Negator(没有)+V+过+N。\nN+V+过+N+没有？",
            "N+V+过+Num+次/遍+N（destination）；\nN+（N）+V+过+N(destination)+Num+次/遍；\nN+V+过+Pron+Num+次",
            "N+比+N+Adj（+Num-M）。\nN+Negator（没有）+N+Adj。",
            "N+V+得+Adj。",
            "N+V+N+V+得+Adj。\nN+V+N+V+得+Adj。",
            "越来越+Adj; \n越来越+Mental Verb（想、喜欢、爱、担心、害怕、习惯）",
        ...
        public static String[] EXAMPLE = {
                ...
                "什么东西又好又便宜我们就买什么东西。\n你去哪儿我就去哪儿。\n你哪天有时间就哪天来我家吧。\n谁喜欢他他就喜欢谁。",
                "上个星期我买了一条裤子，昨天又买了一条。\n你只吃了一点儿饭，再吃一点儿吧。",
                "雨越下越大。\n越往南，天气越热。\n山很高，我们越往上爬，路越难走。我们也越爬越冷。",
                "以前我在我的国家学习中文；现在我在杭州学习中文。（previously）\n我工作以前，我在北京学习计算机。（before）\n这都是以前的事了，别提了。（previous）",
                "感冒以后要多喝水，多休息。（after）\n以后我的中文会说得越来越好。（later）\n以后的事情以后再说，现在不要担心 （future）"
        };
        /**
         * 25种句型的例句的翻译
         */
